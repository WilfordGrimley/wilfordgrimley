...
7. **Export MPC art selection.** On the right side of the page, under 'Export' select 
<details>
  <summary>
    'Copy Decklist - With MPC Art IDs'.
  </summary>
  <img src="assets/images/Copy-Decklist.png" alt="Copy Decklist Button" width="50%"/>
</details>
Alternatively make an account on Proxxied and
<details>
  <summary>
    create a share link
  </summary>
