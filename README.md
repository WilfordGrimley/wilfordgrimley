...
3.  **Select MPC Autofill** on the left side of the page under<details><summary>'Preferred Art Source'.</summary><img src="assets/images/preferred-art-source.png" alt="Preferred Art Source Selection MPC Fill" width="50%"/></details>
...
7. **Export MPC art selection.** On the right side of the page, under 'Export' select <details><summary>'Copy Decklist - With MPC Art IDs'.</summary><img src="assets/images/Copy-Decklist.png" alt="Copy Decklist Button" width="50%"/></details>
Alternatively make an account on Proxxied and<details><summary>create a share link</summary><img src="assets/images/sharelink.png" alt="Share Link Button" width="50%"/></details>from the top right of the page.
